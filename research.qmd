...
::: {.media-content}
## Clay-Wolkin Fellowship: Very Large Scale Integration (VLSI) 


  <!-- Image floats left -->
<img src="images/Claywolkin.png" 
     alt="Clay-Wolkins Logo" 
  ...
  <p class="justify-text" style="overflow-wrap: break-word; font-size: clamp(18px, 2.5vw, 22px); line-height: 1.8;">
    ...
    Applied instruction-set simulation, SystemVerilog simulation, and coverage analysis techniques to understand RISC-V specifications, debug test behavior, and evaluate microprocessor verification workflows.
  </p>
